...
var (
	...
	BookingCounter = promauto.NewCounterVec(prometheus.CounterOpts{
		Name: "booking_bookings_total",
		Help: "Total bookings by type",
	}, []string{"type"})

	BookingStatusCounter = promauto.NewCounterVec(prometheus.CounterOpts{
		Name: "booking_status_total",
		Help: "Booking status changes",
	}, []string{"status"})
)
